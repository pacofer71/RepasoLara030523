    ...
    <div class="p-8 rounded-xl shadow-xl w-1/2 mx-auto bg-gray-300">
        <form name="as" method="POST" action="{{ route('posts.update', $post) }}">
            ...
            <div class="mb-4">
                ...
                <textarea rows='4'
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                    id="contenido" placeholder="Contenido del post..." name="contenido">{{$post->contenido}}</textarea>
                @error('contenido')
                    <p class="text-red-700 text-xs italic mt-2">***{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="flex mb-4">
                <div class="flex items-center mr-4">
                    <input id="si" type="radio" value="SI" name="publicado" @checked($post->publicado=="SI")
                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    <label for="si" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-900">SI</label>
                </div>
                <div class="flex items-center mr-4">
                    <input id="no" type="radio" value="NO" name="publicado" @checked($post->publicado=="NO")
                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
